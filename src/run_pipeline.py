...
# Input/Output paths
input_path = PROJECT_ROOT / "data" / "cleaned_text" / "BMW_2014_Sustainability_clean.txt"
output_dir = PROJECT_ROOT / "results" / "strict_classifier results"
output_jsonl = output_dir / "BMW_2014_strict_classified.jsonl"
output_excel = output_dir / "BMW_2014_strict_classified.xlsx"
...
print(f"\n{'='*60}")
print(f"📊 CLASSIFICATION SUMMARY - BMW 2014")
print(f"{'='*60}")

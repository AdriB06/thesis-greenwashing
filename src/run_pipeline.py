...
# Input/Output paths
input_path = PROJECT_ROOT / "data" / "cleaned_text" / "Toyota_2020_Sustainability_clean.txt"
output_dir = PROJECT_ROOT / "results" / "strict_classifier results"
output_jsonl = output_dir / "Toyota_2020_strict_classified.jsonl"
output_excel = output_dir / "Toyota_2020_strict_classified.xlsx"
...
print(f"\n{'='*60}")
print(f"📊 CLASSIFICATION SUMMARY - Toyota 2020")
print(f"{'='*60}")

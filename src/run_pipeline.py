...
# Input/Output paths
input_path = PROJECT_ROOT / "data" / "cleaned_text" / "Synthetic_2024_clean.txt"
output_dir = PROJECT_ROOT / "results" / "strict_classifier results"
output_jsonl = output_dir / "Synthetic_2024_strict_classified.jsonl"
output_excel = output_dir / "Synthetic_2024_strict_classified.xlsx"
...
print(f"\n{'='*60}")
print(f"📊 CLASSIFICATION SUMMARY - Synthetic 2024")
print(f"{'='*60}")
